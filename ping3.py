...
URLS = [
    ...
    "https://top-and-bottom-hunter.onrender.com"'
    "https://crypto-scalping.onrender.com"
]

def send_pings():
    """دالة إرسال النبضات في الخلفية كل 5 دقائق"""
    while True:
        logging.info("🔗 [الكود 3] بدء جولة النبضات (كل 5 دقائق)...")
        ...
        logging.info("⏳ [الكود 3] انتظار 5 دقائق للجولة التالية...")
